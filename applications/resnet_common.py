...
from tensorflow.python.keras.applications.resnet import (BASE_WEIGHTS_PATH,
                                                         WEIGHTS_HASHES, ResNet,
...
ResNet50 = lambda input_shape, last_stride1=1: init_resnet(
    ...
    model_name="resnet50",
    input_shape=input_shape,
    block_name_to_hyperparameters_dict=OrderedDict([("conv2", (64, 3, 1)),
                                                    ("conv3", (128, 4, 2)),
                                                    ("conv4", (256, 6, 2)),
                                                    ("conv5",
                                                     (512, 3, last_stride1))]),
...
ResNet50V2 = lambda input_shape: init_resnet(
    ...
    input_shape=input_shape,
    block_name_to_hyperparameters_dict=OrderedDict([("conv2", (64, 3, 2)),
                                                    ("conv3", (128, 4, 2)),
                                                    ("conv4", (256, 6, 2)),
                                                    ("conv5", (512, 3, 1))]),
...
ResNeXt50 = lambda input_shape: init_resnet(
    ...
    input_shape=input_shape,
    block_name_to_hyperparameters_dict=OrderedDict([("conv2", (128, 3, 1)),
                                                    ("conv3", (256, 4, 2)),
                                                    ("conv4", (512, 6, 2)),
                                                    ("conv5", (1024, 3, 2))]),
